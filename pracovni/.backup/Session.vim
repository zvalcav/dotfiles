...
silent only
cd /mnt/ssd/Sync/Programming/linux/bash/comarr/pracovni
...
badd +0 check-server
badd +0 cronrun
badd +0 era-mysql-backup
badd +0 ldap-transfer
badd +0 mysql-backup
badd +0 postgresql-backup
badd +0 rsync-backup
badd +0 script-downloader
...
setlocal fdn=20
setlocal fen
let s:l = 208 - ((65 * winheight(0) + 33) / 66)
